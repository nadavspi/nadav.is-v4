...
import SmallsBefore from "./two-principles-for-making-better-websites/smalls-before.jpg";
import SmallsAfter from "./two-principles-for-making-better-websites/smalls-after.jpg";
...
>
> line length is the hor­i­zon­tal width of the text block. Line length should be an av­er­age of **45–90** characters per line (use your word-count func­tion) or **2–3 low­er­case alphabets**&hellip;
...
<figure>
    <Image src={SmallsBefore} alt="Schedule from the Smalls Jazz Club website" />
...
<div class="wide">
  ...
  <figure class="half">
    <Image src={SmallsAfter} alt="My improvements for the Smalls schedule" />
